...
@Service
public class GeneralPermissionService extends GeneralService {
  ...
  public SqlEntity selectDynamic(@GraphQLArgument(name = "tableName") String tableName,
    ...
    getPermissionVisitorList(applicationContext).forEach(permissionVisitor -> permissionVisitor.visit(source));
