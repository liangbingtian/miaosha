 ...
 */
@Service
public class GeneralService extends AbstractCommonService implements ITestGQLService {
  ...
  public SqlEntity selectDynamic(@GraphQLArgument(name = "tableName") String tableName,
      ...
      @GraphQLArgument(name = "sourceCondition") SourceCondition sourceCondition) {
   ...
   * @return
   */
  protected Source getCountSourceFromArguments(String tableName, SourceCondition sourceCondition) {
    Source source = new Source();
    Fields fields = new Fields();
    Field field = new Field();
    Aggr aggr = new Aggr();
  ...
  private void copy(SourceCondition sourceCondition, Source source, Fields fields,
      String tableName) {
